...
using Newtonsoft.Json.Linq;//let me use jObject
...
namespace testProj
{
    public class WebRequest
    {
        ...
        //make sure the line where it says action's datatype in the <> matches what i am asking for when getting pokedata
        {
            ...
            using (var Client = new HttpClient())
            {
                try
                {
                    ...
                    //line below is an example of what a call would look like
